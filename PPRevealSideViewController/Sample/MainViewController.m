...
- (void)showRight {
    ...
    else [self.revealSideViewController pushViewController:c onDirection:PPRevealSideDirectionRight withOffset:_offset animated:_animated];
...
- (IBAction)showUp:(id)sender {
    ...
    else [self.revealSideViewController pushViewController:n onDirection:PPRevealSideDirectionTop withOffset:_offset animated:_animated];
    PP_RELEASE(c);
    PP_RELEASE(n);
}
...
- (IBAction)showDown:(id)sender {
    ...
    else [self.revealSideViewController pushViewController:c onDirection:PPRevealSideDirectionBottom withOffset:_offset animated:_animated];
    PP_RELEASE(c);
}
...
- (void)setOption:(PPRevealSideOptions)option fromSwitch:(UISwitch *)sw {
    if (sw.on) [self.revealSideViewController setOption:option];
    else [self.revealSideViewController resetOption:option];
}
...
- (IBAction)pushOldLeft:(id)sender {
    ...
    else [self.revealSideViewController pushOldViewControllerOnDirection:PPRevealSideDirectionLeft withOffset:_offset animated:YES];
}
...
- (IBAction)pushOldRight:(id)sender {
    ...
    else [self.revealSideViewController pushOldViewControllerOnDirection:PPRevealSideDirectionRight withOffset:_offset animated:YES];
}

- (IBAction)changePanOpened:(id)sender {
    PPRevealSideInteractions inter = PPRevealSideInteractionNone;
    if (_panNavOpenedSwitch.on) inter |= PPRevealSideInteractionNavigationBar;
    if (_panContentOpenedSwitch.on) inter |= PPRevealSideInteractionContentView;
...
- (IBAction)changePanClosed:(id)sender {
    PPRevealSideInteractions inter = PPRevealSideInteractionNone;
    if (_panNavClosedSwitch.on) inter |= PPRevealSideInteractionNavigationBar;
    if (_panContentClosedSwitch.on) inter |= PPRevealSideInteractionContentView;
...
- (IBAction)changeTap:(id)sender {
    PPRevealSideInteractions inter = PPRevealSideInteractionNone;
    if (_tapNavSwitch.on) inter |= PPRevealSideInteractionNavigationBar;
    if (_tapContentSwitch.on) inter |= PPRevealSideInteractionContentView;
